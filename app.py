...
scalar = pickle.load(open('./Data_Splitting/Scalar.pkl', 'rb'))
print(model)

db = psycopg2.connect(host="ec2-34-236-94-53.compute-1.amazonaws.com",user="lewxvsgshkopxm",password="5b940fc742d4bacbbbe9a759aa7cc3ee72ba773d83ca41dda67cc3c2bbd291f8",database="dbh3143a18tjno")
cur = db.cursor()
...
def predict():
    ...
    if request.method == 'POST':
        ...
        print(cols)
        scaled_col = scalar.transform(cols)
        print(scaled_col)
